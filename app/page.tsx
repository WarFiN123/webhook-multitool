...
export default function WebhookTool() {
  ...
  const saveWebhook = () => {
    ...
    const newWebhooks = [...savedWebhooks, { name: webhookName, url: webhookUrl }]
  ...
  const sendWebhook = async () => {
    ...
    try {
      ...
      if (useEmbed) {
        ...
        if (embedColor) embed.color = Number.parseInt(embedColor.replace("#", ""), 16)
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-6 text-center">Discord Webhook Multi-Tool</h1>
        ...
        <TabsContent value="message" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter your webhook URL and customize the sender</CardDescription>
            </CardHeader>
                ...
                <div className="flex gap-2">
                  ...
                  {savedWebhooks.length > 0 && (
                    <div className="relative">
                      ...
                      <div className="absolute z-10 w-56 mt-2 right-0 bg-popover rounded-md shadow-lg overflow-hidden">
            ...
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Compose your webhook message</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                  ...
                  {useEmbed && (
                    <div className="space-y-4 pt-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <ColorPicker color={embedColor} onChange={setEmbedColor} />
                      </div>
        ...
        <TabsContent value="webhooks" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage your saved Discord webhooks</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                {savedWebhooks.length === 0 ? (
                  <p className="text-muted-foreground">No webhooks saved yet. Add one above.</p>
                ) : (
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex gap-2">
                                ...
                                <Button variant="destructive" size="icon" onClick={() => deleteWebhook(index)}>
                                  <Trash2 className="h-4 w-4" />
                                </Button>
                              </div>
                            </div>
